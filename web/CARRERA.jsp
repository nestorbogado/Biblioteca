...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading text-right">
                                <button type="button" class="btn btn-default btn-lg" data-toggle="modal" data-target="#agregar" data-backdrop="static" data-keyboard="false">Agregar Carrera</button>
                            </div>
                            <!-- /.panel-heading -->
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="form-group col-sm-6">
                                  ...
                                  <div class="form-group col-sm-6">
                                    <label>FACULTAD </label><span class = "rojo"> * </span>
                                    <select class="form-control" id="facultad" style="width: 100%" >
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    <label>FACULTAD </label><span class = "rojo"> * </span>
                                    <select class="form-control" id="Efacultad" style="width: 100%" >
        ...
        <script src="./consultas/carrera.js"></script> 
