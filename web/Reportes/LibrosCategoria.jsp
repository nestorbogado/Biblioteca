<%-- 
    Document   : LibrosCategoria
    Created on : 28/11/2018, 07:50:22 PM
    Author     : USUARIO
--%>
...
File reportFile = new File(application.getRealPath("/ArchivoReporte/ReporteLibrosporCategoria.jasper")); 
