<%-- 
    Document   : LibrosOrdAlfaCarreras
    Created on : 20/11/2018, 06:52:57 PM
    Author     : USUARIO
--%>
...
File reportFile = new File(application.getRealPath("/ArchivoReporte/LibrosAlfaCarreras.jasper")); 
