                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading text-right">
                                ...
                                <button type="button" class="btn btn-default btn-lg" data-toggle="modal" data-target="#agregar" data-backdrop="static" data-keyboard="false">Agregar Categoria</button>
                            </div>
                            <div class="row">
                                <div class="col-lg-4">
                                    <label>Busqueda Exacta(Nombre):</label>
                                    <input class="form-control" type="text"  id="nombreBuscar"><br>
                                    <button type="button" class="btn btn-primary" id="Buscar" >Buscar</button>
                                    <button type="button" class="btn btn-info" id="TODOS" >Actualizar</button>
                                </div>
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <table style="width: 100%" class="table table-striped table-bordered table-hover" id="TablaCategorias">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Categorias</th>
            ...
            <div class="modal-dialog"> 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="agregarCategoria" >Guardar Datos</button>
                    </div>
                </div>
            </div>
        </div>
