                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading text-right">
                                <button type="button" class="btn btn-default btn-lg" data-toggle="modal" data-target="#agregar" data-backdrop="static" data-keyboard="false">Agregar Libro</button>
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <table style="width: 100%" class="table table-striped table-bordered table-hover" id="TablaLibros">
                                    <thead>
                                        <tr>
                                            <th>ISBN </th>
                                            <th>TITULO</th>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="form-group col-sm-3">
                                    <label>ISBN</label>
                                    <input class="form-control" type="text" style="width: 100%" id="isbn">
                                </div>
                                <div class="form-group col-sm-3">
                                    <label>AÑO DE PUBLICACIÓN</label>
                                    <input class="form-control" type="text" id="anho">
                                </div>
                                <div class="form-group col-sm-3">
                                    <label>TITULO</label>
                                ...
                                <div class="form-group col-sm-3">
                                    <label>NUMERACIÓN DEWEY</label>
                                    <input class="form-control" type="text"  id="dewey">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-3">
                                    ...
                                    <select class="form-control" id="editorial" style="width: 100%">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                                ...
                                <div class="form-group col-sm-3">
                                    <label>GENERO</label>
                                    <select class="form-control" id="genero" style="width: 100%">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <label>AUTOR </label>
                                    <select class="form-control" multiple="multiple" id="autor" style="width: 100%">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select class="form-control" id="categoria"  multiple="multiple" style="width: 100%">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
        ...
        <div id="editar" class="modal fade " role="dialog">
            <div class="modal-dialog modal-lg"> 
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Editar Datos del Libro</h4>
                    </div>
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <label>ISBN</label>
                                    <input class="form-control" type="text" style="width: 100%" id="Eisbn">
                                </div>
                                <div class="form-group col-sm-6">
                                    <label>AÑO DE PUBLICACIÓN</label>
                                    <input class="form-control" type="text" id="Eanho">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    <label>TITULO</label>
                                    <input class="form-control" type="text" id="Etitulo">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    <label>AUTOR</label>
                                    <select class="form-control" id="Eautor"style="width: 100%">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <label>GENERO</label>
                                    <select class="form-control" id="Egenero" style="width: 100%">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                                ...
                                <div class="form-group col-sm-6">
                                    <label>ESTADO</label>
                                    <input class="form-control" type="text"  id="Eestado">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-6">
