    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (accion.equalsIgnoreCase("cargarTabla")) {
                ...
                es.add("datos", tipoDAO.listarTablaTipo());
                out.print(es);
            }
            ...
            if (accion.equalsIgnoreCase("insertar")) {
                ...
                out.print(tipoDAO.agregarTipo(nombre));
            }
            if (accion.equalsIgnoreCase("eliminar")) {
                int id=Integer.valueOf(request.getParameter("id"));
                out.print(tipoDAO.eliminarTipo(id));
            }
            if (accion.equalsIgnoreCase("cargarDatos")) {
                int id=Integer.valueOf(request.getParameter("id"));
                out.print(tipoDAO.cargarDatosTipo(id));
            }
            if (accion.equalsIgnoreCase("actualizar")) {
                int id=Integer.valueOf(request.getParameter("id"));
                String nombre=request.getParameter("tipo");
                out.print(tipoDAO.actualizarTipo(id, nombre));
            }
        }
    }
